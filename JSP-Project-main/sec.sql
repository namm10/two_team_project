...
CREATE TABLE SCHEDULE( 
	...
	runtime int, 
	roomNo int, -- 번호
    CONSTRAINT FK_tripNo foreign key(tripNo) REFERENCES movie(tripNo)
);
...
INSERT INTO t_Board(articleNO, parentNO, title, content, imageFileName, writedate, id)
    VALUES(1, 0, '테스트글입니다.','테스트글입니다.', null, now(), 'test');

INSERT INTO t_Board(articleNO, parentNO, title, content, imageFileName, writedate, id)
    VALUES(2, 0, '안녕하세요.','상품 후기입니다.', null, now(), 'test');

INSERT INTO t_Board(articleNO, parentNO, title, content, imageFileName, writedate, id)
    VALUES(3, 2, '답변입니다.','상품 후기에 대한 답변입니다..', null, now(), 'test');
    
INSERT INTO t_Board(articleNO, parentNO, title, content, imageFileName, writedate, id)
    VALUES(5, 3, '답변입니다.','상품 좋습니다.', null, now(), 'test');
    
INSERT INTO t_Board(articleNO, parentNO, title, content, imageFileName, writedate, id)
    VALUES(4, 0, '김유신입니다.','김유신 글입니다.', null, now(), 'test');
    
INSERT INTO t_Board(articleNO, parentNO, title, content, imageFileName, writedate, id)
    VALUES(6, 2, '상품 후기입니다.','이순신씨의 상품 후기를 올립니다!', null, now(), 'test');
